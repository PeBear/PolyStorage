 ...
 * @author xPeter
 */
public class FrameThemKhachHang extends javax.swing.JFrame {

    /**
     * Creates new form FrameUpdate
     */
    public FrameThemKhachHang(KhachHang khachHang) {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtMaDT.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
    ...
    private void btnSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSaveMouseClicked
        ...
        if (loi.equals("")) {
            ...
            if (capNhat) {
                if (khachHangDAOImpl.updateKhachHang(model)) {
                    DialogHelper.showMessageDialog(this, "Câp nhật khách hàng thành công.");
                    PanelDanhSachKhachHang.reload.fillToTable(null);
                } else {
                    DialogHelper.showMessageDialog(this, "Câp nhật khách hàng thất bại.");
                }
            } else {
                if (khachHangDAOImpl.insertKhachHang(model)) {
                    DialogHelper.showMessageDialog(this, "Thêm khách hàng thành công.");
                    PanelDanhSachKhachHang.reload.fillToTable(null);
                } else {
                    DialogHelper.showMessageDialog(this, "Thêm khách hàng thất bại.");
                }
            }
        } else {
    ...
    private void showDetail() {
        txtMaDT.setText(khachHang.getMaKH());
    ...
    private String checkInput() {
        ...
        } else if (!txtMaDT.getText().matches("[a-zA-Z0-9]+")) {
            txtMaDT.setBackground(Color.yellow);
            txtMaDT.requestFocus();
            return "Sai định dạng mã khách hàng.";
        }
        ...
        if (txtHoTen.getText().isEmpty()) {
            ...
            txtHoTen.setBackground(Color.yellow);
            txtHoTen.requestFocus();
            return "Sai định dạng tên khách hàng.";
        }
    ...
    private KhachHang getModel() {
        String maKH = txtMaDT.getText();
        String hoTen = txtHoTen.getText();
        String email = txtEmail.getText();
        String sdt = txtSDT.getText();
        String diaChi = txtDiaChi.getText();

        KhachHang khachHang = new KhachHang(maKH, hoTen, email, sdt, diaChi);
        return khachHang;
    }
}
