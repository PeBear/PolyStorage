...
public class RemoveButton extends AbstractCellEditor
        implements TableCellRenderer, TableCellEditor, ActionListener {

    JTable table;
    JButton renderButton;
    String text;
    ImageIcon icon = new ImageIcon(getClass().getResource("/icon/icon-remove.png"));

    public RemoveButton(JTable table, int column, ActionListener actionListener) {
        super();
        this.table = table;
